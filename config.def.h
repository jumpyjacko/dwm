...
static Key keys[] = {
	...
	{ MODKEY,                       XK_F2,     spawn,          SHCMD("light -U 1 && echo \"\" | dnote -id \"Brightness\" -pbar $(light -G) 1.00") },
	{ MODKEY,                       XK_F3,     spawn,          SHCMD("light -A 1 && echo \"\" | dnote -id \"Brightness\" -pbar $(light -G) 1.00") },
	{ MODKEY,                       XK_F4,     spawn,          SHCMD("pamixer -d 1 && echo \"\" | dnote -id \"Volume\" -pbar $(pamixer --get-volume) 100") },
	{ MODKEY,                       XK_F5,     spawn,          SHCMD("pamixer -i 1 && echo \"\" | dnote -id \"Volume\" -pbar $(pamixer --get-volume) 100") },
